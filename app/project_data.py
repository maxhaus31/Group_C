...
class ProjectData:
    ...
    1. Downloads all required datasets (Function 1).
    2. Merges map geometry with all CSV datasets (Function 2).
    3. Reads raw datasets into DataFrame attributes.
    ...
    def __init__(self, config: ProjectDataConfig | None = None) -> None:
        ...
        Args:
            config: Optional validated pydantic configuration.
                If omitted, default paths are used.
        """
